...
public class ChicChocServlet {
    ...
    private RequestHandler getHandler(final Request request) {
    ...
    private void initRequestHandlers() {
        requestHandlers.addAll(List.of(new LoginPageRequestHandler(), new LoginRequestHandler()));
    }

    private boolean supportFilter(final Request request) {
        return loginFilter.support(request);
    }

    private void applyViewName(final String viewName, final Response response) {
