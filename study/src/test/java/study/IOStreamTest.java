...
class IOStreamTest {
    ...
    class InputStream_학습_테스트 {
        ...
        void InputStream은_데이터를_바이트로_읽는다() throws IOException {
             ...
             */
            final String actual = new BufferedReader(new InputStreamReader(inputStream, StandardCharsets.UTF_8)).lines().findAny()
                    .get();
    ...
    class InputStreamReader_학습_테스트 {
        ...
        void BufferedReader를_사용하여_문자열을_읽어온다() {
            ...
            final StringBuilder actual = new StringBuilder(bufferedReader.lines().map(line -> line + "\r\n").collect(Collectors.joining()));
