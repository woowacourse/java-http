...
//            }
    ...
    class InputStreamReader_학습_테스트 {
        ...
        void BufferedReader를_사용하여_문자열을_읽어온다() throws IOException {
            ...
            final InputStreamReader reader = new InputStreamReader(inputStream); // 바이트 대신 문자 단위로 처리
            final BufferedReader bufferedReader = new BufferedReader(reader); // read by line
