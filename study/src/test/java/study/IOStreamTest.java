...
class IOStreamTest {
    ...
    class InputStream_학습_테스트 {
        ...
        void InputStream은_데이터를_바이트로_읽는다() throws IOException {
            ...
            int buf;
            for (int i = 0; i < bytes.length && (buf = inputStream.read()) != -1; i++) {
                data[i] = (byte) buf;
            }
            final String actual = new String(data);
    ...
    class InputStreamReader_학습_테스트 {
        ...
        void BufferedReader를_사용하여_문자열을_읽어온다() throws IOException {
            ...
            while (bufferedReader.ready()) {
                actual.append(bufferedReader.readLine()).append(System.lineSeparator());
            }
