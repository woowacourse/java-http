...
class ThreadPoolsTest {
    ...
    void testNewFixedThreadPool() {
        ...
        final int expectedPoolSize = 2;     // 스레드 2개 실행 중
        final int expectedQueueSize = 1;    // 작업 1개 대기 중
    ...
    void testNewCachedThreadPool() {
        ...
        // 올바른 값으로 바꿔서 테스트를 통과시키자.
        final int expectedPoolSize = 3;  // 작업 3개에 대한 스레드 3개 생성
        final int expectedQueueSize = 0; // 큐는 항상 비어있음
