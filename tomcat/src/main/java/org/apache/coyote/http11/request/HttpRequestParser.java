...
public class HttpRequestParser {
    ...
    private static void validateEmpty(final String startLine) throws IOException {
        if (startLine == null) {
            throw new IOException("Start Line is Empty");
        }
    }

    private static String findQuery(final String pathWithQuery, final String[] pathWithQueryTokens) {
    ...
    private static RequestBody makeRequestBody(final BufferedReader reader, final HttpHeader httpHeader) throws IOException {
