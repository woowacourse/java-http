...
class IOStreamTest {
    ...
    class OutputStream_학습_테스트 {
        ...
        void OutputStream은_사용하고_나서_close_처리를_해준다() throws IOException {
             ...
             */
            try (outputStream) {
                outputStream.write("hi everyone".getBytes());
            }
    ...
    class InputStream_학습_테스트 {
        ...
        void InputStream은_데이터를_바이트로_읽는다() throws IOException {
             ...
             */
            final String actual = StreamUtils.copyToString(inputStream, StandardCharsets.UTF_8);
    ...
    class FilterStream_학습_테스트 {
        ...
        void 필터인_BufferedInputStream를_사용해보자() throws IOException {
            ...
            final InputStream inputStream = new ByteArrayInputStream(text.getBytes()); // 버퍼에 저장한 데이터
            final InputStream bufferedInputStream = new BufferedInputStream(
                    inputStream); // BufferedInputStream은 FilterInputStream의 하위 클래스
