...
public abstract class AbstractController implements Controller {
    ...
    @Override
    public ResponseEntity service(final HttpRequest request, final HttpResponse response) {
    ...
    protected ResponseEntity doPostRequest(final HttpRequest request, final HttpResponse response) {
        return ResponseEntity.forwardTo(HttpStatus.METHOD_NOT_ALLOWED, "/405.html");
    }
}
