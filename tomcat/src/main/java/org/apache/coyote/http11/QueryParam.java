...
public class QueryParam {
    ...
    private static final String KEY_AND_VALUE_PAIR_DELIMITER = "&";
    ...
    private Map<String, String> toParameters(final String path) {
        ...
        String queryString = path.split("\\?")[QUERY_PARAM];
        for(String keyAndValue : queryString.split(KEY_AND_VALUE_PAIR_DELIMITER)) {
            String key = keyAndValue.split(KEY_AND_VALUE_DELIMITER)[QUERY_PARAM_KEY];
            String value = keyAndValue.split(KEY_AND_VALUE_DELIMITER)[QUERY_PARAM_VALUE];
