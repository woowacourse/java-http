...
class ThreadPoolsTest {
    ...
    void testNewFixedThreadPool() {
        ...
        /* fixedThreadPool로 생성된 풀은 고정된 최대 크기를 가집니다. 그런데 현재 스레드가 3개가 실행되므로
        풀의 크기는 최대 크기인 2입니다. 1개의 작업이 대기하고 있으므로 큐의 크기는 1입니다.
         */
    ...
    void testNewCachedThreadPool() {
        ...
        /*
        newCachedThreadPool로 생성된 풀은 쓰레드가 사용가능해지면 최대 60초동안 이를 캐싱했다가 사용합니다.
        최대 풀 사이즈의 제한은 Integer_MAX 입니다.
        별도로 대기하지 않으므로 큐의 크기는 항상 0입니다.
         */
