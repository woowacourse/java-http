...
class IOStreamTest {
    ...
    class OutputStream_학습_테스트 {
        ...
        void BufferedOutputStream을_사용하면_버퍼링이_가능하다() throws IOException {
             ...
             * 버퍼링된 출력 스트림을 구현. 애플리케이션은 기록된 각 바이트에 대해 기본 시스템을 호출하지 않고도 기본 출력 스트림에 바이트를 쓸 수 있음.
             *
    ...
    class InputStream_학습_테스트 {
        ...
        void InputStream은_데이터를_바이트로_읽는다() throws IOException {
            ...
            final String actual = new BufferedReader(new InputStreamReader(inputStream))
                .lines()
    ...
    class FilterStream_학습_테스트 {
        ...
        void 필터인_BufferedInputStream를_사용해보자() throws IOException {
            ...
            final InputStream bufferedInputStream = new BufferedInputStream(inputStream); // size : 8192
