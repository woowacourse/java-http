...
class IOStreamTest {
    ...
    class OutputStream_학습_테스트 {
        ...
        void OutputStream은_데이터를_바이트로_처리한다() throws IOException {
            // "nextstep" 문자열의 각 문자를 ASCII 값으로 나타낸 것
    ...
    class InputStreamReader_학습_테스트 {
        ...
        void BufferedReader를_사용하여_문자열을_읽어온다() throws IOException {
            ...
            final InputStream bufferedInputStream = new BufferedInputStream(inputStream);
            final String data = new String(bufferedInputStream.readAllBytes());
            final StringBuilder actual = new StringBuilder().append(data);
