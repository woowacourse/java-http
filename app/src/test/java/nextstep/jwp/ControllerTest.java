...
public class ControllerTest {
    ...
    public class CallControllerTest {
        ...
        void notFound() {
            //given
            RequestLine requestLine = RequestLine.createFromPlainText("GET /unknown HTTP/1.1 ");
        ...
        void index() {
            //given
            RequestLine requestLine = RequestLine.createFromPlainText("GET /index HTTP/1.1 ");
            RequestHeader requestHeader = new RequestHeader(new HashMap<>() {{
                put("Host", "localhost:8080 ");
                put("Connection", "keep-alive ");
            }});
        ...
        @DisplayName("자원 컨트롤러 호출")
        @Test
        void resource() {
            //given
            RequestLine requestLine = RequestLine.createFromPlainText("GET /css/style.css HTTP/1.1 ");
            RequestHeader requestHeader = new RequestHeader(new HashMap<>() {{
                put("Host", "localhost:8080 ");
                put("Connection", "keep-alive ");
            }});
