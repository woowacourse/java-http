...
class HttpRequestStartLineTest {
    ...
    void validateTest_whenMatchProtocolVersion() {
        ...
        assertThatCode(() -> new HttpRequestStartLine(DEFAULT_METHOD, DEFAULT_PATH, protocolVersion))
    ...
    void validateTest_whenNotMatchProtocolVersion_throwException() {
        ...
        assertThatThrownBy(() -> new HttpRequestStartLine(DEFAULT_METHOD, DEFAULT_PATH, protocolVersion))
