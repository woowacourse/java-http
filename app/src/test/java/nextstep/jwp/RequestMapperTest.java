...
class RequestMapperTest {
    ...
    private static RequestLine indexLine = new RequestLine("GET", Uri.of("/index.html"), "HTTP/1.1");
    ...
    static Stream<Arguments> testGetController() {
        return Stream.of(
                ...
                Arguments.of(HttpRequest.of(indexLine, null, null), new IndexController()));
    }
}
