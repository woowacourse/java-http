...
class FileTest {
    ...
    void resource_디렉터리에_있는_파일의_경로를_찾는다() throws IOException {
        ...
        // todo
        final File fileAtResource = new ClassPathResource(fileName).getFile();
        final String actual = fileAtResource.getCanonicalPath();
    ...
    void 파일의_내용을_읽는다() throws IOException {
        ...
        // todo
        final Path path = new ClassPathResource(fileName)
                .getFile()
                .toPath();
