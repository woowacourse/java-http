...
class ResponseBodyTest {
    ...
    void 세션을_추가해서_redirect_할_수_있다() {
        // given
        final RequestHeader requestHeader = RequestHeader.from(List.of("GET /index?name=wuga HTTP/1.1"));
        final HttpRequest httpRequest = new HttpRequest(requestHeader, null, null);
        final String page = "/index.html";
