...
public enum ResponsePage {
    LOGIN_IS_NOT_LOGIN("/login", HttpStatus.OK, "/login.html", false),
    LOGIN_IS_LOGIN("/login", HttpStatus.FOUND, "/index.html", true),
    REGISTER_IS_NOT_LOGIN("/register", HttpStatus.OK, "/register.html", false),
    REGISTER_IS_LOGIN("/register", HttpStatus.FOUND, "/index.html", true),
    ;
