...
/**
 * 스레드를 다룰 때 어떤 상황을 조심해야 할까? <br/>
 * - 상태를 가진 한 객체를 여러 스레드에서 동시에 접근할 경우 <br/>
 * - static 변수를 가진 객체를 여러 스레드에서 동시에 접근할 경우 <br/>
 * <br/>
 * 위 경우는 동기화(synchronization)를 적용시키거나 객체가 상태를 갖지 않도록 한다. <br/>
 * 객체를 불변 객체로 만드는 방법도 있다. <br/>
 * <br/>
 * 웹서버는 여러 사용자가 동시에 접속을 시도하기 때문에 동시성 이슈가 생길 수 있다. <br/>
