...
class IOStreamTest {
    ...
    class OutputStream_학습_테스트 {
        ...
        void OutputStream은_사용하고_나서_close_처리를_해준다() throws IOException {
            ...
            try (outputStream) {
                System.out.println("OutputStream 사용~");
            }
...
/*
        private static class TestFilterInputStream extends FilterInputStream {
            public TestFilterInputStream(InputStream in) {
                super(in);
            }
        }*/
