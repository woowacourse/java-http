...
public class LoginRequestAdapter extends HttpPostRequestAdapter {

    private static final Logger log = LoggerFactory.getLogger(LoginRequestAdapter.class);

    public LoginRequestAdapter(
        Class<?> target,
        Method method,
    ...
    public HttpResponse doService(HttpRequest httpRequest) {
        try {
            ...
            method.invoke(target, account, password);
