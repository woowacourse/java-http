...
class RegisterPageHandlerTest {
    ...
    void 생성자는_필요한_정보를_전달하면_RegisterPageHandler를_초기화한다() {
        final RegisterPageHandler actual = new RegisterPageHandler("/login", "/", "/index.html", "static/");
    ...
    void supports_메서드는_지원하는_요청인_경우_true를_반환한다() {
        final RegisterPageHandler handler = new RegisterPageHandler("/login", "/", "/index.html", "static/");
