...
public class PathParser {
    ...
    public static void checkPath(final String requestURI) {
        final var resourceURL = ClassLoader.getSystemClassLoader().getResource(STATIC_RESOURCE_PREFIX + requestURI);
        if (Objects.isNull(resourceURL)) {
            throw new NotFoundResourceException();
        }
    }
