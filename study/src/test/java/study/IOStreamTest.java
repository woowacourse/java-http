...
//            int count = 1_000_000;
//            final OutputStream oneByteStream = new ByteArrayOutputStream(bytes.length * count);
//
//            long start1 = System.nanoTime();
//            for (int i = 0; i < count; i++) {
//                for (byte b : bytes) {
//                    oneByteStream.write(b);
//                }
//            }
//            long end1 = System.nanoTime();
//
//            long start2 = System.nanoTime();
//            final OutputStream bulkStream = new ByteArrayOutputStream(bytes.length * count);
//            for (int i = 0; i < count; i++) {
//                bulkStream.write(bytes);
//            }
//            long end2 = System.nanoTime();
//
//            System.out.println("write(int):    " + (end1 - start1) / 1_000_000.0 + " ms");
//            System.out.println("write(byte[]): " + (end2 - start2) / 1_000_000.0 + " ms");
        ...
        @Test
        void 진짜_객체로_flush_전후의_상태를_검증한다() throws IOException {
            String input = "nextstep";

            ByteArrayOutputStream destination = new ByteArrayOutputStream();
            BufferedOutputStream bufferedStream = new BufferedOutputStream(destination, 8192);

            bufferedStream.write(input.getBytes());
            assertThat(destination.toString()).isEmpty();

            bufferedStream.flush();
            assertThat(destination.toString()).isEqualTo(input);
...
//            }
            bufferedReader.lines().forEach(line -> actual.append(line).append("\r\n"));
