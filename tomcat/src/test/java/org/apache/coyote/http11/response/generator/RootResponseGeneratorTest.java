...
class RootResponseGeneratorTest {
    ...
    void isSuitable(String request, boolean expected) throws IOException {
        ...
        boolean actual = ROOT_RESPONSE_GENERATOR.isSuitable(HttpRequest.from(bufferedReader));
    ...
    void generate() throws IOException {
        ...
        HttpResponse httpResponse = ROOT_RESPONSE_GENERATOR.generate(HttpRequest.from(bufferedReader));
