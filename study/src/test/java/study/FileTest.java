...
class FileTest {
     ...
     */
    @Test
    void resource_디렉터리에_있는_파일의_경로를_찾는다() throws IOException, URISyntaxException {
        ...
        // 3. URL을 Path 객체로 변환하여 파일 시스템 경로를 얻는다.
        Path resourcePath = Paths.get(resourceUrl.toURI());
        String resource = resourcePath.getFileName().toString();

        assertThat(resource).endsWith(fileName);
    }
