...
class IOStreamTest {
     ...
     */
    @DisplayName("OutputStream_학습_테스트")
    @Nested
    class OutputStreamTest {
         ...
         */
        @DisplayName("OutputStream은_데이터를_바이트로_처리한다")
        @Test
        void byteProcessing() throws IOException {
         ...
         */
        @DisplayName("BufferedOutputStream을_사용하면_버퍼링이_가능하다")
        @Test
        void buffering() throws IOException {
         ...
         */
        @DisplayName("OutputStream은_사용하고_나서_close_처리를_해준다")
        @Test
     ...
     */
    @DisplayName("InputStream_학습_테스트")
    @Nested
    class InputStreamTest {
         ...
         */
        @DisplayName("InputStream은_데이터를_바이트로_읽는다")
        @Test
         ...
         * 장시간 스트림을 닫지 않으면 파일, 포트 등 다양한 리소스에서 누수(leak)가 발생한다.
         */
        @DisplayName("InputStream은_사용하고_나서_close_처리를_해준다")
        @Test
        void close() throws IOException {
     ...
     */
    @DisplayName("FilterStream_학습_테스트")
    @Nested
    class FilterStreamTest {
         ...
         */
        @DisplayName("필터인_BufferedInWutStream를_사용해보자")
        @Test
        void useBufferedIn_OutStream() throws IOException {
     ...
     */
    @DisplayName("InputStreamReader_학습_테스트")
    @Nested
    class InputStreamReaderTest {
         ...
         */
        @DisplayName("BufferedReader를_사용하여_문자열을_읽어온다")
        @Test
