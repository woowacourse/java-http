...
class RegexTest {
    ...
    @Test
    void stringAfterSpecificString0_stringExists() {
    ...
    @Test
    void stringAfterSpecificString0_stringNotExists() {
        final Pattern pattern = Pattern.compile("/login.*");
    ...
    @Test
    void stringAfterSpecificString0_noSpecificString() {
        final Pattern pattern = Pattern.compile("/login.*");
    ...
    @Test
    void stringAfterSpecificString0_stringBeforeSpecificString() {
        final Pattern pattern = Pattern.compile("/login.*");
    ...
    @DisplayName("특정 문자열 뒤에 1개 이상의 문자가 나열되는 정규식 - 1개 이상의 문자")
    @Test
    void stringAfterSpecificString1_stringExists() {
        final Pattern pattern = Pattern.compile("access=.+");
        final Matcher matcher = pattern.matcher("access=gugu");

        assertThat(matcher.find()).isTrue();
    }

    @DisplayName("특정 문자열 뒤에 1개 이상의 문자가 나열되는 정규식 - 0개의 문자")
    @Test
    void stringAfterSpecificString1_stringNotExists() {
        final Pattern pattern = Pattern.compile("access=.+");
        final Matcher matcher = pattern.matcher("access=");
