...
class HomeControllerTest extends ControllerTest {
    ...
    void doGet() throws IOException {
        ...
        final Controller homeController = HomeController.getInstance();
        final HttpRequest httpRequest = getHttpRequest("GET", "/");

        // when
        final HttpResponse httpResponse = homeController.doService(httpRequest);
    ...
    @Test
    @DisplayName("POST / 요청은 500.html을 응답한다.")
    void doPost() throws IOException {
        ...
        final Controller homeController = HomeController.getInstance();
        final HttpRequest httpRequest = getHttpRequest("POST", "/");
