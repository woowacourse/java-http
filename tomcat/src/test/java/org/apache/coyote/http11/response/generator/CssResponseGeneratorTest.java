...
class CssResponseGeneratorTest {
    ...
    void isSuitable(String request, boolean expected) throws IOException {
        ...
        boolean actual = CSS_RESPONSE_GENERATOR.isSuitable(HttpRequest.from(bufferedReader));
    ...
    void generate() throws IOException {
        ...
        HttpResponse httpResponse = CSS_RESPONSE_GENERATOR.generate(HttpRequest.from(bufferedReader));
