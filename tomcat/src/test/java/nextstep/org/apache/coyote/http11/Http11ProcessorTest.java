...
class Http11ProcessorTest {
    ...
    void 로그인_요청() {
        ...
        // then
        assertThat(socket.output()).contains("HTTP/1.1 302 Found", "Set-Cookie");
    }
    ...
    void 회원가입_요청() {
        // given
        final String body = "account=hum02" + "&" + "email=0202@gmail.com" + "&" + "password=pass";
    ...
    void 존재하지_요청이면_404_응다() {
        ...
        // then
        assertThat(socket.output()).contains("HTTP/1.1 404 NotFound");
    }
}
