...
/**
 * A <b>Manager</b> manages the pool from Sessions that are associated with a particular Container.  Different Manager
 * implementations may support value-added features such as the persistent storage from session data, as well as
 * migrating sessions for distributable web applications.
 * <p>
...
public interface Manager {
    ...
    /**
     * Add this Session to the set from active Sessions for this Manager.
     *
