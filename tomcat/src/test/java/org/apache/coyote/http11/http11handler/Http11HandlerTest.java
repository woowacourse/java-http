...
class Http11HandlerTest {
    ...
    void extractElements_DefaultPageHandler() {
        ...
        assertAll(
                ...
                () -> assertThat(responseComponent.getContentType()).isEqualTo(
                        ExtensionContentType.HTML.getContentType()),
                () -> assertThat(responseComponent.getContentLength()).isEqualTo(
    ...
    void extractElements_IndexPageHandler() {
        ...
        assertAll(
                ...
                () -> assertThat(responseComponent.getBody()).isEqualTo(
    ...
    void extractElements_ResourceHandle() {
        ...
        assertAll(
                () -> assertThat(responseComponent.getStatusCode()).isEqualTo(StatusCode.OK),
                () -> assertThat(responseComponent.getContentType()).isEqualTo(
                        ExtensionContentType.CSS.getContentType()),
    ...
    void extractElements_LoginPageHandle_QueryString_Success() {
        ...
        final URL resource = getClass().getClassLoader().getResource("static/index.html");
        assertAll(
                () -> assertThat(responseComponent.getStatusCode()).isEqualTo(StatusCode.REDIRECT),
                () -> assertThat(responseComponent.getContentType()).isEqualTo(
                        ExtensionContentType.HTML.getContentType()),
                () -> assertThat(responseComponent.getContentLength()).isEqualTo(contentLength),
                () -> assertThat(responseComponent.getBody()).isEqualTo(
