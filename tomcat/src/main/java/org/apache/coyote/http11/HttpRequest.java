...
public class HttpRequest {
    ...
    private HttpRequest(final String method, final String path, final String version,
    ...
    private static void putQueryParameter(final Map<String, String> parameters, final String pair) {
