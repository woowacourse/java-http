...
class IOStreamTest {
    ...
    class OutputStream_학습_테스트 {
        ...
        void BufferedOutputStream을_사용하면_버퍼링이_가능하다() throws IOException {
            ...
            /*
            ByteArrayOutputStream과의 차이
            출력 데이터를 메모리에 저장하고, toByteArray() 등으로 꺼내 사용한다.
            */
        ...
        void OutputStream은_사용하고_나서_close_처리를_해준다() throws IOException {
            ...
            try (BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(outputStream)) {
                bufferedOutputStream.write(new byte[]{101, 102});
            }
    ...
    class InputStream_학습_테스트 {
        ...
        void InputStream은_데이터를_바이트로_읽는다() throws IOException {
            ...
            // 이 바이트는 UTF-8로 인코딩된거니까 UTF-8로 디코딩해줘!
            String actual = new String(readBytes, StandardCharsets.UTF_8);
